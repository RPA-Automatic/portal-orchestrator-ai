...
> Fonte: `docs/integrations/solution-design-architecture-agent.md`
...
> Relacionados: `../product/agent-catalog.md` (`docs/product/agent-catalog.md`), `../architecture/SDD.md` (`docs/architecture/SDD.md`)
